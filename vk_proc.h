...
#define VK_PROC_INIT_PUBLIC(proc_ptr, map_len, entered) vk_proc_init(proc_ptr, NULL, map_len, PROT_READ|PROT_WRITE, MAP_ANON|MAP_PRIVATE, -1, 0, entered)
#define VK_PROC_INIT_PRIVATE( proc_ptr, map_len, entered) vk_proc_init(proc_ptr, NULL, map_len, PROT_NONE,            MAP_ANON|MAP_PRIVATE, -1, 0, entered)
